!function (e, t) {
    ...
    "use strict";
    var e = navigator.userAgent, t = navigator.platform, d = /gecko\/\d/i.test(e), n = /MSIE \d/.test(e),
        r = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(e), i = /Edge\/(\d+)/.exec(e), w = n || r || i,
        v = w && (n ? document.documentMode || 6 : +(i || r)[1]), f = !i && /WebKit\//.test(e),
        r = f && /Qt\/\d+\.\d+/.test(e), o = !i && /Chrome\//.test(e), p = /Opera\//.test(e),
        c = /Apple Computer/.test(navigator.vendor), l = /Mac OS X 1\d\D([8-9]|\d\d)\D/.test(e),
        u = /PhantomJS/.test(e), s = c && (/Mobile\/\w+/.test(e) || 2 < navigator.maxTouchPoints),
        a = /Android/.test(e), h = s || a || /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(e),
        g = s || /Mac/.test(t), m = /\bCrOS\b/.test(e), y = /win/i.test(t), e = p && e.match(/Version\/(\d*\.\d*)/);
    ...
    var se, ae, ue, ce, he,
        de = (se = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/, ae = /[stwN]/, ue = /[LRr]/, ce = /[Lb1n]/, he = /[1n]/, function (e, t) {
            ...
            for (var O, A = [], D = 0; D < i;) if (ce.test(o[D])) {
                ...
                for (++D; D < i && "L" != o[D]; ++D) ;
                for (var E = H; E < D;) if (he.test(o[E])) {
    ...
    function dt(t, n, r, e) {
        ...
        for (var u = r.state, o = 0; o < t.state.overlays.length; ++o) !function (e) {
            ...
            r.state = !0, xt(t, n.text, o.mode, r, function (e, t) {
                for (var n = l; s < e;) {
                    var r = a[l];
    ...
    function gt(e, t, n, r) {
        ...
        for (o.start = o.pos = r || 0, "" == t && mt(i, n.state); !o.eol();) vt(i, o, n.state), o.start = o.pos
    }
    ...
    function bt(e, t, n, r) {
        var i, o, l = e.doc, s = l.mode, a = Ye(l, (t = at(l, t)).line), u = pt(e, t.line, n),
            c = new Xe(a.text, e.options.tabSize, u);
        for (r && (o = []); (r || c.pos < t.ch) && !c.eol();) c.start = c.pos, i = vt(s, c, u.state), r && o.push(new yt(c, i, Ve(l.mode, u.state)));
    ...
    function xt(e, t, n, r, i, o, l) {
        ...
        var a = 0, u = null, c = new Xe(t, e.options.tabSize, r), h = e.options.addModeClass && [null];
    ...
    function Tt(e, t) {
        ...
        if (!n && !r) return null;
        var i = t.from.ch, o = t.to.ch, e = 0 == nt(t.from, t.to), l = function (e, t, n) {
            var r;
        ...
        if (s) for (var f = 0; f < s.length; ++f) {
            var p = s[f];
            null != p.to && (p.to += u), null == p.from ? kt(l, p.marker) || (p.from = u, a && (l = l || []).push(p)) : (p.from += u, a && (l = l || []).push(p))
        }
        l = l && Mt(l), s && s != l && (s = Mt(s));
        var g = [l];
        if (!a) {
            var m, v = t.text.length - 2;
            if (0 < v && l) for (var y = 0; y < l.length; ++y) null == l[y].to && (m = m || []).push(new Lt(l[y].marker, null, null));
    ...
    function Wt(e, t) {
        ...
        if (0 != n) return n;
        var r = e.find(), i = t.find(), n = nt(r.from, i.from) || At(e) - At(t);
        if (n) return -n;
    ...
    function Et(e, t, n, r, i) {
        var t = Ye(e, t), o = St && t.markedSpans;
        if (o) for (var l = 0; l < o.length; ++l) {
            var s = o[l];
            if (s.marker.collapsed) {
                var a = s.marker.find(0), u = nt(a.from, n) || At(s.marker) - At(i),
                    c = nt(a.to, r) || Dt(s.marker) - Dt(i);
                if (!(0 <= u && c <= 0 || u <= 0 && 0 <= c) && (u <= 0 && (s.marker.inclusiveRight && i.inclusiveLeft ? 0 <= nt(a.to, n) : 0 < nt(a.to, n)) || 0 <= u && (s.marker.inclusiveRight && i.inclusiveLeft ? nt(a.from, r) <= 0 : nt(a.from, r) < 0))) return 1
            }
        }
    }
    ...
    function Vt(e) {
        ...
        n.maxLine = Ye(e, e.first), n.maxLineLength = Ut(n.maxLine), n.maxLineChanged = !0, e.iter(function (e) {
            var t = Ut(e);
    ...
    function $t(e, t) {
        ...
        for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
            ...
            r.pos = 0, r.addToken = qt, function (e) {
                ...
                var t = k(e, document.createTextNode("AخA")), n = W(t, 0, 1).getBoundingClientRect(),
                ...
                if (r) for (var l, s, a, u, c, h, d, f = i.length, p = 0, g = 1, m = "", v = 0; ;) {
                    if (v == p) {
                        ...
                        if (!h || h.from == p) for (var k = 0; k < y.length; ++k) Zt(t, 0, y[k]);
                        if (h && (h.from || 0) == p) {
                ...
                } else for (var O = 1; O < n.length; O += 2) t.addToken(t, i.slice(o, o = n[O]), Yt(n[O + 1], t.cm.options))
            }(o, r, ft(e, o, t != e.display.externalMeasured && Ze(o))), o.styleClasses && (o.styleClasses.bgClass && (r.bgClass = D(o.styleClasses.bgClass, r.bgClass || "")), o.styleClasses.textClass && (r.textClass = D(o.styleClasses.textClass, r.textClass || ""))), 0 == r.map.length && r.map.push(0, 0, r.content.appendChild(function (e) {
    ...
    function Qt(e, t, n) {
        this.line = t, this.rest = function (e) {
            for (var t, n; t = Pt(e);) e = t.find(1, !0).line, (n = n || []).push(e);
            return n
        }(t), this.size = this.rest ? Ze(Y(this.rest)) - n + 1 : 1, this.node = this.text = null, this.hidden = Bt(e, t)
    }

    function Jt(e, t, n) {
        for (var r = [], i = t; i < n; i = l) {
            var o = new Qt(e.doc, Ye(e.doc, i), i), l = i + o.size;
            r.push(o)
        }
        return r
    }
    ...
    function ln(e, t, n, r) {
        for (var i = 0; i < t.changes.length; i++) {
            var o = t.changes[i];
            "text" == o ? function (e, t) {
                var n = t.text.className, r = an(e, t);
                t.text == t.node && (t.node = r.pre);
                t.text.parentNode.replaceChild(r.pre, t.text), t.text = r.pre, r.bgClass != t.bgClass || r.textClass != t.textClass ? (t.bgClass = r.bgClass, t.textClass = r.textClass, un(e, t)) : n && (t.text.className = n)
    ...
    function un(e, t) {
        var n, r;
        n = e, (r = (i = t).bgClass ? i.bgClass + " " + (i.line.bgClass || "") : i.line.bgClass) && (r += " CodeMirror-linebackground"), i.background ? r ? i.background.className = r : (i.background.parentNode.removeChild(i.background), i.background = null) : r && (e = sn(i), i.background = e.insertBefore(M("div", null, r), e.firstChild), n.display.input.setUneditable(i.background)), t.line.wrapClass ? sn(t).className = t.line.wrapClass : t.node != t.text && (t.node.className = "");
    ...
    function cn(e, t, n, r) {
        ...
        if (e.options.lineNumbers || i) {
            ...
            if (l.setAttribute("aria-hidden", "true"), e.display.input.setUneditable(l), o.insertBefore(l, t.text), t.line.gutterClass && (l.className += " " + t.line.gutterClass), !e.options.lineNumbers || i && i["CodeMirror-linenumbers"] || (t.lineNumber = l.appendChild(M("div", et(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + r.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))), i) for (var s = 0; s < e.display.gutterSpecs.length; ++s) {
    ...
    function hn(e, t, n) {
        if (dn(e, t.line, t, n, !0), t.rest) for (var r = 0; r < t.rest.length; r++) dn(e, t.rest[r], t, n, !1)
    }

    function dn(e, t, n, r, i) {
        if (t.widgets) for (var o = sn(n), l = 0, s = t.widgets; l < s.length; ++l) {
            ...
            }(a, u, n, r), e.display.input.setUneditable(u), i && a.above ? o.insertBefore(u, n.gutter || n.text) : o.appendChild(u), rn(a, "redraw")
        }
    }
    ...
    function pn(e, t) {
        for (var n = Ne(t); n != e.wrapper; n = n.parentNode) if (!n || 1 == n.nodeType && "true" == n.getAttribute("cm-ignore-events") || n.parentNode == e.sizer && n != e.mover) return 1
    }
    ...
    function Ln(e, t) {
        ...
        o && !o.text ? o = null : o && o.changes && (ln(e, o, i, _n(e)), e.curOp.forceUpdate = !0), o || (n = e, e = Ze(r = It(r = t)), (r = n.display.externalMeasured = new Qt(n.doc, r, e)).lineN = e, e = r.built = $t(n, r), r.text = e.pre, k(n.display.lineMeasure, e.pre), o = r);
        i = xn(o, t, i);
    ...
    function kn(e, t, n, r, i) {
        ...
        return t.cache.hasOwnProperty(l) ? o = t.cache[l] : (t.rect || (t.rect = t.view.text.getBoundingClientRect()), t.hasHeights || (function (e, t, n) {
            var r = e.options.lineWrapping, e = r && bn(e);
            ...
            if (3 == l.nodeType) {
                for (var c = 0; c < 4; c++) {
                    ...
                    if ((i = w && v < 9 && 0 == s && a == o.coverEnd - o.coverStart ? l.parentNode.getBoundingClientRect() : function (e, t) {
                        ...
                        return n
                    }(W(l, s, a).getClientRects(), r)).left || i.right || 0 == s) break;
                    a = s, s -= 1, u = "right"
                }
    ...
    var Tn, Mn = {left: 0, right: 0, top: 0, bottom: 0};
    ...
    function Dn(e) {
        An(e), e.display.cachedCharWidth = e.display.cachedTextHeight = e.display.cachedPaddingH = null, e.options.lineWrapping || (e.display.maxLineChanged = !0), e.display.lineNumChars = null
    }
    ...
    function Fn(e) {
        var t = It(e).widgets, n = 0;
        if (t) for (var r = 0; r < t.length; ++r) t[r].above && (n += fn(t[r]));
        return n
    }

    function Pn(e, t, n, r, i) {
        if (i || (i = Fn(t), n.top += i, n.bottom += i), "line" == r) return n;
        r = r || "local";
        t = Gt(t);
    ...
    function Rn(n, e, r, i, o, l) {
        ...
        var a = pe(i, n.doc.direction), t = e.ch, u = e.sticky;
    ...
    function Gn(e, t, n) {
        ...
        if (o < i) return Bn(r.first + r.size - 1, Ye(r, o).text.length, null, 1, 1);
        t < 0 && (t = 0);
        for (var l = Ye(r, i); ;) {
            var s = function (n, e, t, r, i) {
                i -= Gt(e);
                var o = Ln(n, e), l = Fn(e), s = 0, a = e.text.length, u = !0, c = pe(e, n.doc.direction);
    ...
    function Xn(e, t, n, r, i, o, l) {
        var l = Un(e, t, r, l), s = l.begin, a = l.end;
    ...
    function Yn(e) {
        ...
        if (null == Tn) {
            ...
            for (var t = 0; t < 49; ++t) Tn.appendChild(document.createTextNode("x")), Tn.appendChild(M("br"));
    ...
    function Zn(r) {
        var i = Yn(r.display), o = r.options.lineWrapping,
    ...
    function tr(e, t, n, r) {
        ...
        var i, o, l = e.display;
        (r = r || 0) && n < l.viewTo && (null == l.updateLineNumbers || l.updateLineNumbers > t) && (l.updateLineNumbers = t), e.curOp.viewChanged = !0, t >= l.viewTo ? St && Rt(e.doc, t) < l.viewTo && rr(e) : n <= l.viewFrom ? St && zt(e.doc, n + r) > l.viewFrom ? rr(e) : (l.viewFrom += r, l.viewTo += r) : t <= l.viewFrom && n >= l.viewTo ? rr(e) : t <= l.viewFrom ? (i = ir(e, n, n + r, 1)) ? (l.view = l.view.slice(i.index), l.viewFrom = i.lineN, l.viewTo += r) : rr(e) : n >= l.viewTo ? (o = ir(e, t, t, -1)) ? (l.view = l.view.slice(0, o.index), l.viewTo = o.lineN) : rr(e) : (i = ir(e, t, t, -1), o = ir(e, n, n + r, 1), i && o ? (l.view = l.view.slice(0, i.index).concat(Jt(e, i.lineN, o.lineN)).concat(l.view.slice(o.index)), l.viewTo += r) : rr(e));
    ...
    function sr(e, t) {
        ...
        l && (t = !0);
        for (var s, a, u, c = 0; c < n.sel.ranges.length; c++) !t && c == n.sel.primIndex || ((s = n.sel.ranges[c]).from().line >= e.display.viewTo || s.to().line < e.display.viewFrom || (a = s.empty(), l ? (u = l(e, s)) && ar(e, u, i) : (a || e.options.showCursorWhenSelecting) && ar(e, s.head, i), a || function (i, e, t) {
            var n = i.display, o = i.doc, l = document.createDocumentFragment(), r = vn(i.display), S = r.left,
                L = Math.max(n.sizerWidth, bn(i) - n.sizer.offsetLeft) - r.right, k = "ltr" == o.direction;
            ...
            function s(n, g, m) {
                ...
                function x(e, t, n) {
                    e = Vn(i, r, null, e), t = "ltr" == t == ("after" == n) ? "left" : "right";
                ...
                return function (e, t, n, r) {
                    ...
                    var i, o, l, s, a = "ltr" == n, u = w(e, a ? "left" : "right"), c = w(t - 1, a ? "right" : "left"),
                        h = null == g && 0 == e, d = null == m && t == b, f = 0 == r, p = !C || r == C.length - 1;
    ...
    function fr(e, t) {
        e.state.delayingBlurEvent && !e.state.draggingText && (e.state.delayingBlurEvent = !1), "nocursor" != e.options.readOnly && (e.state.focused || (be(e, "focus", e, t), e.state.focused = !0, A(e.display.wrapper, "CodeMirror-focused"), e.curOp || e.display.selForContextMenu == e.doc.sel || (e.display.input.reset(), f && setTimeout(function () {
    ...
    function gr(e) {
        for (var t = e.display, n = t.lineDiv.offsetTop, r = Math.max(0, t.scroller.getBoundingClientRect().top), i = t.lineDiv.getBoundingClientRect().top, o = 0, l = 0; l < t.view.length; l++) {
            ...
            if (!a.hidden) {
                i += a.line.height, w && v < 8 ? (c = (s = a.node.offsetTop + a.node.offsetHeight) - n, n = s) : (c = (d = a.node.getBoundingClientRect()).bottom - d.top, !u && a.text.firstChild && (h = a.text.firstChild.getBoundingClientRect().right - d.left - 1));
                var d = a.line.height - c;
                if ((.005 < d || d < -.005) && (i < r && (o -= d), qe(a.line, c), mr(a.line), a.rest)) for (var f = 0; f < a.rest.length; f++) mr(a.rest[f]);
    ...
    function vr(e, t, n) {
        var r = n && null != n.top ? Math.max(0, n.top) : e.scroller.scrollTop, r = Math.floor(r - gn(e)),
            i = n && null != n.bottom ? n.bottom : r + e.wrapper.clientHeight, o = Qe(t, r), r = Qe(t, i);
    ...
    function yr(e, t) {
        ...
        var s = e.doc.height + mn(n), a = t.top < r, r = t.bottom > s - r;
        ...
        var i = e.options.fixedGutter ? 0 : n.gutters.offsetWidth,
            ...
            e = bn(e) - n.gutters.offsetWidth, n = t.right - t.left > e;
    ...
    function Lr(e, t) {
        Math.abs(e.doc.scrollTop - t) < 2 || (d || Kr(e, {top: t}), kr(e, t, !0), d && Kr(e), zr(e, 100))
    }
    ...
    function Tr(e, t, n, r) {
        t = Math.max(0, Math.min(t, e.display.scroller.scrollWidth - e.display.scroller.clientWidth)), (n ? t == e.doc.scrollLeft : Math.abs(e.doc.scrollLeft - t) < 2) && !r || (e.doc.scrollLeft = t, Yr(e), e.display.scroller.scrollLeft != t && (e.display.scroller.scrollLeft = t), e.display.scrollbars.setScrollLeft(t))
    }

    function Mr(e) {
        var t = e.display, n = t.gutters.offsetWidth, r = Math.round(e.doc.height + mn(e.display));
        return {
    ...
    e = function (e, t, n) {
        ...
        r.tabIndex = i.tabIndex = -1, e(r), e(i), me(r, "scroll", function () {
    ...
    e.prototype.update = function (e) {
        ...
        this.horiz.style.height = this.vert.style.width = g && !l ? "12px" : "18px", this.horiz.style.pointerEvents = this.vert.style.pointerEvents = "none", this.disableHoriz = new I, this.disableVert = new I
    ...
    function Dr(n) {
        n.display.scrollbars && (n.display.scrollbars.clear(), n.display.scrollbars.addClass && S(n.display.wrapper, n.display.scrollbars.addClass)), n.display.scrollbars = new Ar[n.options.scrollbarStyle](function (e) {
            n.display.wrapper.insertBefore(e, n.display.scrollbarFiller), me(e, "mousedown", function () {
        ...
        }, n), n.display.scrollbars.addClass && A(n.display.wrapper, n.display.scrollbars.addClass)
    }
    ...
    function Hr(e) {
        e.curOp = {
            ...
            id: ++Wr,
            markArrays: null
        }, e = e.curOp, en ? en.ops.push(e) : e.ownsGroup = en = {ops: [e], delayedCallbacks: []}
    }
        ...
        e && tn(e, function (e) {
            ...
            !function (e) {
                for (var t = e.ops, n = 0; n < t.length; n++) !function (e) {
                    ...
                    })(t), e.updateMaxLine && Vt(t);
                    e.mustUpdate = e.viewChanged || e.forceUpdate || null != e.scrollTop || e.scrollToPos && (e.scrollToPos.from.line < n.viewFrom || e.scrollToPos.to.line >= n.viewTo) || n.maxLineChanged && t.options.lineWrapping, e.update = e.mustUpdate && new Gr(t, e.mustUpdate && {
                        top: e.scrollTop,
                ...
                for (var l = 0; l < t.length; l++) !function (e) {
                    ...
                    null != e.scrollLeft && Tr(t, e.scrollLeft, !0, !0);
                    {
                        ...
                        e.scrollToPos && (i = function (e, t, n, r) {
                            null == r && (r = 0), e.options.lineWrapping || t != n || (n = "before" == t.sticky ? tt(t.line, t.ch + 1, "before") : t, t = t.ch ? tt(t.line, "before" == t.sticky ? t.ch - 1 : t.ch, "after") : t);
                            for (var i = 0; i < 5; i++) {
                                ...
                                if (null != u.scrollTop && (Lr(e, u.scrollTop), 1 < Math.abs(e.doc.scrollTop - s) && (l = !0)), null != u.scrollLeft && (Tr(e, u.scrollLeft), 1 < Math.abs(e.doc.scrollLeft - a) && (l = !0)), !l) break
                            }
                            return o
                    ...
                    if (o) for (var s = 0; s < o.length; ++s) o[s].lines.length || be(o[s], "hide");
                    if (l) for (var a = 0; a < l.length; ++a) l[a].lines.length && be(l[a], "unhide");
    ...
    function Br(l) {
        ...
        c.highlightFrontier >= l.display.viewTo || (s = +new Date + l.options.workTime, a = pt(l, c.highlightFrontier), u = [], c.iter(a.line, Math.min(c.first + c.size, l.display.viewTo + 500), function (e) {
            if (a.line >= l.display.viewFrom) {
                var t = e.styles, n = e.text.length > l.options.maxHighlightLength ? Ve(c.mode, a.state) : null,
                    r = dt(l, e, a, !0);
            ...
            } else e.text.length <= l.options.maxHighlightLength && gt(l, e.text, a), e.stateAfter = a.line % 5 == 0 ? a.save() : null, a.nextLine();
    ...
    var Gr = function (e, t, n) {
        var r = e.display;
        this.viewport = t, this.visible = vr(r, e.doc, t), this.editorIsHidden = !r.wrapper.offsetWidth, this.wrapperHeight = r.wrapper.clientHeight, this.wrapperWidth = r.wrapper.clientWidth, this.oldDisplayWidth = bn(e), this.force = n, this.dims = _n(e), this.events = []
    };
    ...
    function Ur(e, t) {
        ...
        n.viewFrom < o && o - n.viewFrom < 20 && (o = Math.max(r.first, n.viewFrom)), n.viewTo > l && n.viewTo - l < 20 && (l = Math.min(i, n.viewTo)), St && (o = Rt(e.doc, o), l = zt(e.doc, l));
        var s = o != n.viewFrom || l != n.viewTo || n.lastWrapHeight != t.wrapperHeight || n.lastWrapWidth != t.wrapperWidth;
        r = o, i = l, 0 == (l = (o = e).display).view.length || r >= l.viewTo || i <= l.viewFrom ? (l.view = Jt(o, r, i), l.viewFrom = r) : (l.viewFrom > r ? l.view = Jt(o, r, l.viewFrom).concat(l.view) : l.viewFrom < r && (l.view = l.view.slice(er(o, r))), l.viewFrom = r, l.viewTo < i ? l.view = l.view.concat(Jt(o, l.viewTo, i)) : l.viewTo > i && (l.view = l.view.slice(0, er(o, i)))), l.viewTo = i, n.viewOffset = Gt(Ye(e.doc, n.viewFrom)), e.display.mover.style.top = n.viewOffset + "px";
        o = or(e);
        ...
        return 4 < o && (n.lineDiv.style.display = "none"), function (n, e, t) {
            ...
            for (var a = r.view, u = r.viewFrom, c = 0; c < a.length; c++) {
                ...
                if (!h.hidden) if (h.node && h.node.parentNode == o) {
                    ...
                    h.changes && (-1 < R(h.changes, "gutter") && (d = !1), ln(n, h, u, t)), d && (L(h.lineNumber), h.lineNumber.appendChild(document.createTextNode(et(n.options, u)))), l = h.node.nextSibling
                } else {
                    d = function (e, t, n, r) {
                        var i = an(e, t);
    ...
    function Vr(e, t) {
        for (var n = t.viewport, r = !0; ; r = !1) {
            if (r && e.options.lineWrapping && t.oldDisplayWidth != bn(e)) r && (t.visible = vr(e.display, e.doc, n)); else if (n && null != n.top && (n = {top: Math.min(e.doc.height + mn(e.display) - wn(e), n.top)}), t.visible = vr(e.display, e.doc, n), t.visible.from >= e.display.viewFrom && t.visible.to <= e.display.viewTo) break;
            if (!Ur(e, t)) break;
            gr(e);
            var i = Mr(e);
    ...
    function Yr(e) {
        ...
        if (t.alignWidgets || t.gutters.firstChild && e.options.fixedGutter) {
            for (var r = qn(t) - t.scroller.scrollLeft + e.doc.scrollLeft, i = t.gutters.offsetWidth, o = r + "px", l = 0; l < n.length; l++) if (!n[l].hidden) {
    ...
    function Qr(e, t, n, r) {
        var i = this;
        this.input = n, i.scrollbarFiller = M("div", null, "CodeMirror-scrollbar-filler"), i.scrollbarFiller.setAttribute("cm-not-content", "true"), i.gutterFiller = M("div", null, "CodeMirror-gutter-filler"), i.gutterFiller.setAttribute("cm-not-content", "true"), i.lineDiv = T("div", null, "CodeMirror-code"), i.selectionDiv = M("div", null, null, "position: relative; z-index: 1"), i.cursorDiv = M("div", null, "CodeMirror-cursors"), i.measure = M("div", null, "CodeMirror-measure"), i.lineMeasure = M("div", null, "CodeMirror-measure"), i.lineSpace = T("div", [i.measure, i.lineMeasure, i.selectionDiv, i.cursorDiv, i.lineDiv], null, "position: relative; outline: none");
        var o = T("div", [i.lineSpace], "CodeMirror-lines");
        i.mover = M("div", [o], null, "position: relative"), i.sizer = M("div", [i.mover], "CodeMirror-sizer"), i.sizerWidth = null, i.heightForcer = M("div", null, null, "position: absolute; height: " + z + "px; width: 1px;"), i.gutters = M("div", null, "CodeMirror-gutters"), i.lineGutter = null, i.scroller = M("div", [i.sizer, i.heightForcer, i.gutters], "CodeMirror-scroll"), i.scroller.setAttribute("tabIndex", "-1"), i.wrapper = M("div", [i.scrollbarFiller, i.gutterFiller, i.scroller], "CodeMirror"), i.wrapper.setAttribute("translate", "no"), w && v < 8 && (i.gutters.style.zIndex = -1, i.scroller.style.paddingRight = 0), f || d && h || (i.scroller.draggable = !0), e && (e.appendChild ? e.appendChild(i.wrapper) : e(i.wrapper)), i.viewFrom = i.viewTo = t.first, i.reportedViewFrom = i.reportedViewTo = t.first, i.view = [], i.renderedView = null, i.externalMeasured = null, i.viewOffset = 0, i.lastWrapHeight = i.lastWrapWidth = 0, i.updateLineNumbers = null, i.nativeBarWidth = i.barHeight = i.barWidth = 0, i.scrollbarsClipped = !1, i.lineNumWidth = i.lineNumInnerWidth = i.lineNumChars = null, i.alignWidgets = !1, i.cachedCharWidth = i.cachedTextHeight = i.cachedPaddingH = null, i.maxLine = null, i.maxLineLength = 0, i.maxLineChanged = !1, i.wheelDX = i.wheelDY = i.wheelStartX = i.wheelStartY = null, i.shift = !1, i.selForContextMenu = null, i.activeTouch = null, i.gutterSpecs = _r(r.gutters, r.lineNumbers), qr(i), n.init(i)
    }
    ...
    function ri(e, t) {
        ...
        if (r && a || i && n) {
            if (i && g && f) e:for (var u = t.target, c = l.view; u != s; u = u.parentNode) for (var h = 0; h < c.length; h++) if (c[h].node == u) {
                e.display.currentWheelTarget = u;
                break e
            }
            if (r && !d && !p && null != o) return i && n && Lr(e, Math.max(0, s.scrollTop + i * o)), Tr(e, Math.max(0, s.scrollLeft + r * o)), i && !n || Le(t), void (l.wheelStartX = null);
    ...
    ii.prototype.primary = function () {
        ...
        for (var e = [], t = 0; t < this.ranges.length; t++) e[t] = new oi(it(this.ranges[t].anchor), it(this.ranges[t].head));
    ...
    function fi(e) {
        ...
        }), e.doc.modeFrontier = e.doc.highlightFrontier = e.doc.first, zr(e, 100), e.state.modeGen++, e.curOp && tr(e)
    }
    ...
    function gi(e, o, t, l) {
        ...
        function n(e, t, n) {
            var r, i;
            r = n, i = l, (n = e).text = t, n.stateAfter && (n.stateAfter = null), n.styles && (n.styles = null), null != n.order && (n.order = null), Nt(n), Ot(n, r), (i = i ? i(n) : 1) != n.height && qe(n, i), rn(e, "change", e, o)
        }
        ...
        var s, a = o.from, u = o.to, c = o.text, h = Ye(e, a.line), d = Ye(e, u.line), f = Y(c), p = i(c.length - 1),
            g = u.line - a.line;
    ...
    function vi(e, t) {
        ...
        Qn((e.doc = t).cm = e), di(e), yi(e), e.options.direction = t.direction, e.options.lineWrapping || Vt(e), e.options.mode = t.modeOption, tr(e)
    }
    ...
    function Ci(e, t, n, r) {
        ...
        i.undone.length = 0;
        var o, l, s = +new Date;
        if ((i.lastOp == r || i.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && i.lastModTime > s - (e.cm ? e.cm.options.historyEventDelay : 500) || "*" == t.origin.charAt(0))) && (o = (a = i).lastOp == r ? (xi(a.done), Y(a.done)) : a.done.length && !Y(a.done).ranges ? Y(a.done) : 1 < a.done.length && !a.done[a.done.length - 2].ranges ? (a.done.pop(), Y(a.done)) : void 0)) l = Y(o.changes), 0 == nt(t.from, t.to) && 0 == nt(t.from, l.to) ? l.to = ai(t) : o.changes.push(wi(e, t)); else {
            var a = Y(i.done);
        ...
        i.done.push(n), i.generation = ++i.maxGeneration, i.lastModTime = i.lastSelTime = s, i.lastOp = i.lastSelOp = r, i.lastOrigin = i.lastSelOrigin = t.origin, l || be(e, "historyAdded")
    }

    function Si(e, t, n, r) {
        var i, o, l, s = e.history, a = r && r.origin;
        n == s.lastSelOp || a && s.lastSelOrigin == a && (s.lastModTime == s.lastSelTime && s.lastOrigin == a || (i = e, o = a, l = Y(s.done), e = t, "*" == (o = o.charAt(0)) || "+" == o && l.ranges.length == e.ranges.length && l.somethingSelected() == e.somethingSelected() && new Date - i.history.lastSelTime <= (i.cm ? i.cm.options.historyEventDelay : 500))) ? s.done[s.done.length - 1] = t : Li(t, s.done), s.lastSelTime = +new Date, s.lastSelOrigin = a, s.lastSelOp = n, r && !1 !== r.clearRedo && xi(s.undone)
    }
            ...
            if (o.ranges) r.push(n ? ii.prototype.deepCopy.call(o) : o); else {
                ...
                for (var a = 0; a < l.length; ++a) {
                    ...
                    if (s.push({
                        ...
                        to: c.to,
                        text: c.text
                    }), t) for (var h in c) (u = h.match(/^spans_(\d+)$/)) && -1 < R(t, Number(u[1])) && (Y(s)[h] = c[h], delete c[h])
                }
            }
        }
        return r
    ...
    function Ei(e, t, n) {
        ...
        (Ce(e, "beforeSelectionChange") || e.cm && Ce(e.cm, "beforeSelectionChange")) && (r = e, i = n, i = {
            ...
            update: function (e) {
                this.ranges = [];
                for (var t = 0; t < e.length; t++) this.ranges[t] = new oi(at(r, e[t].anchor), at(r, e[t].head))
            },
            origin: i && i.origin
        ...
        Ii(e, zi(e, t, o, !0)), n && !1 === n.scroll || !e.cm || "nocursor" == e.cm.getOption("readOnly") || wr(e.cm)
    }
    ...
    function zi(e, t, n, r) {
        for (var i, o = 0; o < t.ranges.length; o++) {
            var l = t.ranges[o], s = t.ranges.length == e.sel.ranges.length && e.sel.ranges[o],
                a = Gi(e, l.anchor, s && s.anchor, n, r), s = Gi(e, l.head, s && s.head, n, r);
            ...
            if ((null == s.from || (u ? s.from <= t.ch : s.from < t.ch)) && (null == s.to || (c ? s.to >= t.ch : s.to > t.ch))) {
                ...
                if (a.atomic) {
                    if (n) {
                        ...
                        if ((h = (r < 0 ? c : u) ? Ui(e, h, -r, h && h.line == t.line ? o : null) : h) && h.line == t.line && (s = nt(h, n)) && (r < 0 ? s < 0 : 0 < s)) return Bi(e, h, t, r, i)
                    }
                    a = a.find(r < 0 ? -1 : 1);
    ...
    function ji(e, t, n) {
        ...
        if (!(Ce(e, "beforeChange") || e.cm && Ce(e.cm, "beforeChange")) || (t = Ki(e, t, !0))) {
            ...
            if (r) for (var i = r.length - 1; 0 <= i; --i) Xi(e, {
                from: r[i].from,
                to: r[i].to,
                text: i ? [""] : t.text,
                origin: t.origin
    ...
    function Xi(e, n) {
        ...
        1 == n.text.length && "" == n.text[0] && 0 == nt(n.from, n.to) || (t = ci(e, n), Ci(e, n, t, e.cm ? e.cm.curOp.id : NaN), _i(e, n, t, Tt(e, n)), r = [], mi(e, function (e, t) {
            t || -1 != R(r, e.history) || (Ji(e.history, n), r.push(e.history)), _i(e, n, null, Tt(e, n))
        }))
    }
            ...
            if (u != s.length) {
                ...
                for (var h = Ce(i, "beforeChange") || i.cm && Ce(i.cm, "beforeChange"), d = l.changes.length - 1; 0 <= d; --d) {
                    var f = function (e) {
                        ...
                        c.push(wi(i, n));
                        var t = e ? ci(i, n) : Y(s);
                        _i(i, n, t, Mi(i, n)), !e && i.cm && i.cm.scrollIntoView({from: n.from, to: ai(n)});
                        var r = [];
                        mi(i, function (e, t) {
                            t || -1 != R(r, e.history) || (Ji(e.history, n), r.push(e.history)), _i(e, n, null, Mi(e, n))
                        })
                    }(d);
                    if (f) return f.v
                }
    ...
    function qi(e, t, n, r, i) {
        var o;
        nt(r = r || n, n) < 0 && (n = (o = [r, n])[0], r = o[1]), "string" == typeof t && (t = e.splitLines(t)), ji(e, {
            from: n,
            to: r,
            text: t,
            origin: i
    ...
    oi.prototype.from = function () {
        ...
        chunkSize: function () {
            ...
            for (var n, r = e, i = e + t; r < i; ++r) {
                var o = this.lines[r];
                this.height -= o.height, (n = o).parent = null, Nt(n), rn(o, "delete")
            }
    ...
    ro.prototype.clear = function () {
        ...
        i && (Bt(this.doc, r) || qe(r, r.height + i), n && Pr(n, function () {
            n.curOp.forceUpdate = !0, io(n, r, i), rn(n, "lineWidgetChanged", n, e, Ze(r))
        }))
    }, Se(ro);
    ...
    function so(r, i, o, e, t) {
        if (e && e.shared) return function (e, n, r, i, o) {
            ...
            return mi(e, function (e) {
                a && (i.widgetNode = a.cloneNode(!0)), l.push(so(e, at(e, n), at(e, r), i, o));
                for (var t = 0; t < e.linked.length; ++t) if (e.linked[t].isParent) return;
                s = Y(l)
            }), new ao(l, s)
        }(r, i, o, e, t);
        if (r.cm && !r.cm.curOp) return Er(r.cm, so)(r, i, o, e, t);
        var l = new oo(r, t), t = nt(i, o);
        if (e && P(e, l, !1), 0 < t || 0 == t && !1 !== l.clearWhenEmpty) return l;
        if (l.replacedWith && (l.collapsed = !0, l.widgetNode = T("span", [l.replacedWith], "CodeMirror-widget"), e.handleMouseEvents || l.widgetNode.setAttribute("cm-ignore-events", "true"), e.insertLeft && (l.widgetNode.insertLeft = !0)), l.collapsed) {
            if (Et(r, i.line, i, o, l) || i.line != o.line && Et(r, o.line, i, o, l)) throw new Error("Inserting collapsed marker partially overlapping an existing one");
            St = !0
        }
        ...
        if (r.iter(a, o.line + 1, function (e) {
            ...
            if (s && (u.curOp.updateMaxLine = !0), l.collapsed) tr(u, i.line, o.line + 1); else if (l.className || l.startStyle || l.endStyle || l.css || l.attributes || l.title) for (var n = i.line; n <= o.line; n++) nr(u, n, "text");
    ...
    oo.prototype.clear = function () {
        if (!this.explicitlyCleared) {
            ...
            n && Hr(t), !Ce(this, "clear") || (e = this.find()) && rn(this, "clear", e.from, e.to);
            for (var r = null, i = null, o = 0; o < this.lines.length; ++o) {
                var l = this.lines[o], s = kt(l.markedSpans, this);
                t && !this.collapsed ? nr(t, Ze(l), "text") : t && (null != s.to && (i = Ze(l)), null != s.from && (r = Ze(l))), l.markedSpans = function (e, t) {
                    for (var n, r = 0; r < e.length; ++r) e[r] != t && (n = n || []).push(e[r]);
                    return n
                }(l.markedSpans, s), null == s.from && this.collapsed && !Bt(this.doc, l) && t && qe(l, Yn(t.display))
            }
            if (t && this.collapsed && !t.options.lineWrapping) for (var a = 0; a < this.lines.length; ++a) {
                var u = It(this.lines[a]), c = Ut(u);
                c > t.display.maxLineLength && (t.display.maxLine = u, t.display.maxLineLength = c, t.display.maxLineChanged = !0)
            }
            null != r && t && this.collapsed && tr(t, r, i + 1), this.lines.length = 0, this.explicitlyCleared = !0, this.atomic && this.doc.cantEdit && (this.doc.cantEdit = !1, t && Ri(t.doc)), t && rn(t, "markerCleared", t, this, r, i), n && Fr(t), this.parent && this.parent.clear()
        }
        ...
        for (var i = 0; i < this.lines.length; ++i) {
            ...
            if (null != l.from && (n = tt(t ? o : Ze(o), l.from), -1 == e)) return n;
        ...
        r && o && Pr(o, function () {
            var e = r.line, t = Ze(r.line), t = Sn(o, t);
            t && (On(t), o.curOp.selectionChanged = o.curOp.forceUpdate = !0), o.curOp.updateMaxLine = !0, Bt(i.doc, e) || null == i.height || (t = i.height, i.height = null, (t = fn(i) - t) && qe(e, e.height + t)), rn(o, "markerChanged", o, n)
        })
    }, oo.prototype.attachLine = function (e) {
        var t;
        !this.lines.length && this.doc.cm && ((t = this.doc.cm.curOp).maybeHiddenMarkers && -1 != R(t.maybeHiddenMarkers, this) || (t.maybeUnhiddenMarkers || (t.maybeUnhiddenMarkers = [])).push(this)), this.lines.push(e)
    ...
    function ho(e, t, n, r, i) {
        ...
        null == n && (n = 0), no.call(this, [new to([new Kt("", null)])]), this.first = n, this.scrollTop = this.scrollLeft = 0, this.cantEdit = !1, this.cleanGeneration = 1, n = tt(this.modeFrontier = this.highlightFrontier = n, 0), this.sel = si(n), this.history = new bi(null), this.id = ++fo, this.modeOption = t, this.lineSep = r, this.direction = "rtl" == i ? "rtl" : "ltr", this.extend = !1, "string" == typeof e && (e = this.splitLines(e)), gi(this, {
            from: n,
            to: n,
            text: e
        }), Pi(this, si(n), G)
    ...
    (ho.prototype = q(no.prototype, {
        constructor: ho, iter: function (e, t, n) {
        ...
        }, getLineNumber: Ze, getLineHandleVisualStart: function (e) {
            ...
            if (e.length) {
                for (var r = [], i = 0; i < e.length; i++) r[i] = new oi(at(this, e[i].anchor), at(this, e[i].head || e[i].anchor));
                null == t && (t = Math.min(e.length - 1, this.sel.primIndex)), Pi(this, li(this.cm, r, t), n)
            }
        }), addSelection: Rr(function (e, t, n) {
            var r = this.sel.ranges.slice(0);
            r.push(new oi(at(this, e), at(this, t || e))), Pi(this, li(this.cm, r, r.length - 1), n)
        }), getSelection: function (e) {
            for (var t = this.sel.ranges, n = 0; n < t.length; n++) var r = $e(this, t[n].from(), t[n].to()), i = i ? i.concat(r) : r;
            ...
            var t = [], n = Ye(this, (e = at(this, e)).line).markedSpans;
            ...
            null != (e = e || {}).from && e.from > t && (t = e.from), null != e.to && e.to < n && (n = e.to);
            ...
            }), t.linked = [{doc: this, isParent: !0, sharedHist: e.sharedHist}], function (e, t) {
            ...
            if (e instanceof cl && (e = e.doc), this.linked) for (var t = 0; t < this.linked.length; ++t) if (this.linked[t].doc == e) {
    ...
    function go(e) {
        ...
        if (mo(r), !we(r, e) && !pn(r.display, e)) {
            ...
            if (t && !r.isReadOnly()) if (n && n.length && window.FileReader && window.File) for (var i = n.length, o = Array(i), l = 0, s = function () {
                ++l == i && Er(r, function () {
                    var e = {
                        from: t = at(r.doc, t), to: t, text: r.doc.splitLines(o.filter(function (e) {
                            return null != e
                        }).join(r.doc.lineSeparator())), origin: "paste"
                    };
                    ji(r.doc, e), Fi(r.doc, si(at(r.doc, t), at(r.doc, ai(e))))
                })()
    ...
    for (var xo = {
        ...
        63277: "PageDown",
        63302: "Insert"
    }, Co = 0; Co < 10; Co++) xo[Co + 48] = xo[Co + 96] = String(Co);
    ...
    function Io(t, n, s, e) {
        ...
        function o(e) {
            return t.options.lineWrapping ? (l = l || Ln(t, n), Vn(t, n, l, e)) : {begin: 0, end: n.text.length}
        }

        var l, c = o("before" == s.sticky ? u(s, -1) : s.ch);
        if ("rtl" == t.doc.direction || 1 == i.level) {
            var h = 1 == i.level == e < 0, d = u(s, h ? 1 : -1);
            if (null != d && (h ? d <= i.to && d <= c.end : d >= i.from && d >= c.begin)) return new tt(s.line, d, h ? "before" : "after")
        }
        h = function (e, t, n) {
    ...
    var Ro = {
        selectAll: Vi, singleSelection: function (e) {
            ...
            return Ho(t, function (e) {
                return {from: tt(e.from().line, 0), to: at(t.doc, tt(e.to().line + 1, 0))}
            })
    ...
    function zo(e, t) {
        var n = Ye(e.doc, t), r = It(n);
        return Eo(!0, e, r, t = r != n ? Ze(r) : t, 1)
    }

    function Bo(e, t) {
        var n = zo(e, t.line), r = Ye(e.doc, n.line), e = pe(r, e.doc.direction);
    ...
    function jo(t, e) {
        ...
        return !!n && (e.shiftKey && !t.state.keySeq ? Vo(t, "Shift-" + n, e, function (e) {
            ...
            if ("string" == typeof e ? /^go[A-Z]/.test(e) : e.motion) return Go(t, e)
        }) : Vo(t, n, e, function (e) {
            return Go(t, e)
        }))
    }
    ...
    function Jo(e) {
        ...
        we(l, e) || s.activeTouch && s.input.supportsTouch() || (s.input.ensurePolled(), s.shift = e.shiftKey, pn(s, e) ? f || (s.scroller.draggable = !1, setTimeout(function () {
            ...
            (e.options.dragDrop && We && !e.isReadOnly() && "single" == n && -1 < (i = l.contains(t)) && (nt((i = l.ranges[i]).from(), t) < 0 || 0 < t.xRel) && (0 < nt(i.to(), t) || t.xRel < 0) ? function (t, n, r, i) {
                ...
                (t.state.draggingText = s).copy = !i.moveOnDrag, me(o.wrapper.ownerDocument, "mouseup", s), me(o.wrapper.ownerDocument, "mousemove", a), me(o.scroller, "dragstart", u), me(o.scroller, "drop", s), t.state.delayingBlurEvent = !0, setTimeout(function () {
                ...
                function s(e) {
                    if (0 != nt(b, e)) if (b = e, "rectangle" == p.unit) {
                        for (var t = [], n = d.options.tabSize, r = E(Ye(g, f.line).text, f.ch, n), i = E(Ye(g, e.line).text, e.ch, n), o = Math.min(r, i), l = Math.max(r, i), s = Math.min(f.line, e.line), a = Math.min(d.lastLine(), Math.max(f.line, e.line)); s <= a; s++) {
                            var u = Ye(g, s).text, c = K(u, o, n);
                            o == l ? t.push(new oi(tt(s, c), tt(s, c))) : u.length > c && t.push(new oi(tt(s, c), tt(s, K(u, l, n))))
                        }
                        t.length || t.push(new oi(f, f)), Pi(g, li(d, y.ranges.slice(0, v).concat(t), v), {
                            origin: "*mouse",
                            scroll: !1
                        }), d.scrollIntoView(e)
                    } else {
                        var h, r = m, i = el(d, e, p.unit), e = r.anchor,
                            ...
                            i = y.ranges.slice(0);
                        i[v] = function (e, t) {
                            var n = t.anchor, r = t.head, i = Ye(e.doc, n.line);
                            ...
                            var i = o[i + (a ? -1 : 0)], a = a == (1 == i.level), i = a ? i.from : i.to,
                                a = a ? "after" : "before";
                            return n.ch == i && n.sticky == a ? t : new oi(new tt(n.line, i, a), r)
                        }(d, new oi(at(g, e), h)), Pi(g, li(d, i, v), U)
                    }
                }
                ...
                function n(e) {
                    d.state.selectingText = !1, u = 1 / 0, e && (Le(e), l.input.focus()), ye(l.wrapper.ownerDocument, "mousemove", r), ye(l.wrapper.ownerDocument, "mouseup", i), g.history.lastSelOrigin = null
                }
                ...
                d.state.selectingText = i, me(l.wrapper.ownerDocument, "mousemove", r), me(l.wrapper.ownerDocument, "mouseup", i)
            })(e, r, t, o)
    ...
    function tl(e, t, n, r) {
        ...
        for (var s = 0; s < e.display.gutterSpecs.length; ++s) {
            ...
            if (a && a.getBoundingClientRect().right >= i) return be(e, n, e, Qe(e.doc, o), e.display.gutterSpecs[s].className, t), Te(t)
        }
    }
    ...
    function ul(e) {
        e.options.lineWrapping ? (A(e.display.wrapper, "CodeMirror-wrap"), e.display.sizer.style.minWidth = "", e.display.sizerWidth = null) : (S(e.display.wrapper, "CodeMirror-wrap"), Vt(e)), Qn(e), tr(e), Dn(e), setTimeout(function () {
            return Nr(e)
        }, 100)
    }
    ...
    function cl(e, t) {
        ...
        for (i in il(o.wrapper.CodeMirror = this), t.lineWrapping && (this.display.wrapper.className += " CodeMirror-wrap"), Dr(this), this.state = {
            ...
            var i = r.display;
            me(i.scroller, "mousedown", Er(r, Jo)), me(i.scroller, "dblclick", w && v < 11 ? Er(r, function (e) {
                var t;
            ...
            me(i.scroller, "touchstart", function (e) {
                ...
                n && !pn(i, e) && null != n.left && !n.moved && new Date - n.start < 300 && (t = r.coordsChar(i.activeTouch, "page"), t = !n.prev || s(n, n.prev) ? new oi(t, t) : !n.prev.prev || s(n, n.prev.prev) ? r.findWordAt(t) : new oi(tt(t.line, 0), at(r.doc, tt(t.line + 1, 0))), r.setSelection(t.anchor, t.head), r.focus(), Le(e)), l()
            }), me(i.scroller, "touchcancel", l), me(i.scroller, "scroll", function () {
            ...
            me(e, "keyup", function (e) {
                return $o.call(r, e)
            }), me(e, "keydown", Er(r, Yo)), me(e, "keypress", Er(r, _o)), me(e, "focus", function (e) {
                return fr(r, e)
        ...
        }, 20) : pr(this), sl) sl.hasOwnProperty(i) && sl[i](this, t[i], ol);
    ...
    function dl(e, t, n, r) {
        ...
        var l = e.options.tabSize, s = Ye(o, t), a = E(s.text, null, l);
        ...
        if (d < c && (h += X(c - d)), h != u) return qi(o, h, tt(t, 0), tt(t, u.length), "+input"), !(s.stateAfter = null);
    ...
    function gl(e, t, n, r, i) {
        ...
        if (s && 1 < r.ranges.length) if (fl && fl.text.join("\n") == t) {
            if (r.ranges.length % fl.text.length == 0) for (var u = [], c = 0; c < fl.text.length; c++) u.push(o.splitLines(fl.text[c]))
        ...
        t && !s && vl(e, t), wr(e), e.curOp.updateInput < 2 && (e.curOp.updateInput = h), e.curOp.typing = !0, e.state.pasteIncoming = e.state.cutIncoming = -1
    }
    ...
    function vl(e, t) {
        if (e.options.electricChars && e.options.smartIndent) for (var n = e.doc.sel, r = n.ranges.length - 1; 0 <= r; r--) {
            ...
            if (!(100 < i.head.ch || r && n.ranges[r - 1].head.line == i.head.line)) {
                ...
                } else o.electricInput && o.electricInput.test(Ye(e.doc, i.head.line).text.slice(0, i.head.ch)) && (l = dl(e, i.head.line, "smart"));
    ...
    function yl(e) {
        for (var t = [], n = [], r = 0; r < e.doc.sel.ranges.length; r++) {
            var i = e.doc.sel.ranges[r].head.line, i = {anchor: tt(i, 0), head: tt(i + 1, 0)};
    ...
    function xl(i, o, l, s, a) {
        var e = o, t = l, u = Ye(i, o.line), c = a && "rtl" == i.direction ? -l : l;
        ...
        function n(e) {
            ...
            if (null == (n = "codepoint" == s ? (t = u.text.charCodeAt(o.ch + (0 < l ? 0 : -1)), isNaN(t) ? null : (n = 0 < l ? 55296 <= t && t < 56320 : 56320 <= t && t < 57343, new tt(o.line, Math.max(0, Math.min(u.text.length, o.ch + l * (n ? 2 : 1))), -l))) : a ? Io(i.cm, u, o, l) : Po(u, o, l))) {
                if (e || (r = o.line + c) < i.first || r >= i.first + i.size || (o = new tt(r, o.ch, o.sticky), !(u = Ye(i, r)))) return;
                o = Eo(a, i.cm, u, o.line, c)
            } else o = n;
            return 1
        }

        if ("char" == s || "codepoint" == s) n(); else if ("column" == s) n(!0); else if ("word" == s || "group" == s) for (var r = null, h = "group" == s, d = i.cm && i.cm.getHelper(o, "wordChars"), f = !0; !(l < 0) || n(!f); f = !1) {
    ...
    function Sl(e, t) {
        ...
        var r = Ye(e.doc, t.line), n = xn(n, r, t.line), r = pe(r, e.doc.direction), e = "left";
    ...
    function kl(e, t, n) {
        ...
        if (t == e.display.lineDiv) {
            if (!(r = e.display.lineDiv.childNodes[n])) return Ll(e.clipPos(tt(e.display.viewTo - 1)), !0);
            t = null, n = 0
            ...
            if (o.node == r) return function (u, e, t) {
                ...
                function l(e, t, n) {
                    for (var r = -1; r < (h ? h.length : 0); r++) for (var i = r < 0 ? c.map : h[r], o = 0; o < i.length; o += 3) {
                        var l = i[o + 2];
                        if (l == e || l == t) {
                            var s = Ze(r < 0 ? u.line : u.rest[r]), a = i[o] + n;
                ...
                for (var f = o.previousSibling, p = t; f; f = f.previousSibling) {
                    if (s = l(f, f.firstChild, -1)) return Ll(tt(s.line, s.ch + p), r);
    ...
    e.prototype.init = function (e) {
        ...
        s.contentEditable = !0, bl(s, l.options.spellcheck, l.options.autocorrect, l.options.autocapitalize), me(s, "paste", function (e) {
        ...
        if (t.display.viewTo == t.display.viewFrom || r.line >= t.display.viewTo || i.line < t.display.viewFrom) e.removeAllRanges(); else {
            ...
            if (!o || o.bad || !n || n.bad || 0 != nt(lt(o, n), r) || 0 != nt(ot(o, n), i)) {
                ...
                if (i || (i = {
                    ...
                    l && (!d && t.state.focused ? (e.collapse(r.node, r.offset), l.collapsed || (e.removeAllRanges(), e.addRange(l))) : (e.removeAllRanges(), e.addRange(l)), s && null == e.anchorNode ? e.addRange(s) : d && this.startGracePeriod()), this.rememberSelection()
        ...
        if (0 == i.ch && i.line > t.firstLine() && (i = tt(i.line - 1, Ye(t.doc, i.line - 1).length)), r.ch == Ye(t.doc, r.line).text.length && r.line < t.lastLine() && (r = tt(r.line + 1, 0)), i.line < n.viewFrom || r.line > n.viewTo - 1) return !1;
        var o,
        ...
        for (var s = t.doc.splitLines(function (l, e, t, s, a) {
            ...
            for (; !function e(t) {
                if (1 == t.nodeType) {
                    ...
                    if (n) f(n); else if (n = t.getAttribute("cm-marker")) (n = l.findMarks(tt(s, 0), tt(a + 1, 0), (o = +n, function (e) {
                        return e.id == o
                    }))).length && (r = n[0].find(0)) && f($e(l.doc, r.from, r.to).join(c)); else if ("false" != t.getAttribute("contenteditable")) {
            ...
            return n
        }(t, l, r, e, o)), a = $e(t.doc, tt(e, 0), tt(o, Ye(t.doc, o).text.length)); 1 < s.length && 1 < a.length;) if (Y(s) == Y(a)) s.pop(), a.pop(), o--; else {
            if (s[0] != a[0]) break;
            s.shift(), a.shift(), e++
        }
        for (var u = 0, c = 0, h = s[0], d = a[0], f = Math.min(h.length, d.length); u < f && h.charCodeAt(u) == d.charCodeAt(u);) ++u;
        for (var p = Y(s), g = Y(a), m = Math.min(p.length - (1 == s.length ? u : 0), g.length - (1 == a.length ? u : 0)); c < m && p.charCodeAt(p.length - c - 1) == g.charCodeAt(g.length - c - 1);) ++c;
    ...
    r.prototype.init = function (n) {
        ...
        function t(e) {
            if (!we(i, e)) {
                if (i.somethingSelected()) pl({lineWise: !1, text: i.getSelections()}); else {
        ...
        n.wrapper.insertBefore(this.wrapper, n.wrapper.firstChild), s && (o.style.width = "0px"), me(o, "input", function () {
        ...
        }), me(o, "cut", t), me(o, "copy", t), me(n.scroller, "paste", function (e) {
            if (!pn(n, e) && !we(i, e)) {
        ...
        if ("nocursor" != this.cm.options.readOnly && (!h || O() != this.textarea)) try {
            this.textarea.focus()
        } catch (e) {
        }
    ...
    }, r.prototype.needsContentAttribute = !1, Ml = (Tl = cl).optionHandlers, Tl.defineOption = Dl, Tl.Init = ol, Dl("value", "", function (e, t) {
        return e.setValue(t)
    }, !0), Dl("mode", null, function (e, t) {
        e.doc.modeOption = t, di(e)
    }, !0), Dl("indentUnit", 2, di, !0), Dl("indentWithTabs", !1), Dl("smartIndent", !0), Dl("tabSize", 4, function (e) {
        fi(e), Dn(e), tr(e)
        ...
        if (e.doc.lineSep = r) {
            ...
            for (var t = i.length - 1; 0 <= t; t--) qi(e.doc, r, i[t], tt(i[t].line, i[t].ch + r.length))
        }
    }), Dl("specialChars", /[\u0000-\u001f\u007f-\u009f\u00ad\u061c\u200b\u200e\u200f\u2028\u2029\ufeff\ufff9-\ufffc]/g, function (e, t, n) {
        e.state.specialChars = new RegExp(t.source + (t.test("\t") ? "" : "|\t"), "g"), n != ol && e.refresh()
    }), Dl("specialCharPlaceholder", _t, function (e) {
        return e.refresh()
    }, !0), Dl("electricChars", !0), Dl("inputStyle", h ? "contenteditable" : "textarea", function () {
    ...
    }, !0), Dl("rtlMoveVisually", !y), Dl("wholeLineUpdateBefore", !0), Dl("theme", "default", function (e) {
        il(e), Zr(e)
    }, !0), Dl("keyMap", "default", function (e, t, n) {
        t = Wo(t), n = n != ol && Wo(n);
        n && n.detach && n.detach(e, t), t.attach && t.attach(e, n || null)
    }), Dl("extraKeys", null), Dl("configureMouse", null), Dl("lineWrapping", !1, ul, !0), Dl("gutters", [], function (e, t) {
    ...
    }, !0), Dl("firstLineNumber", 1, Zr, !0), Dl("lineNumberFormatter", function (e) {
        return e
    }, Zr, !0), Dl("showCursorWhenSelecting", !1, lr, !0), Dl("resetSelectionOnContextMenu", !0), Dl("lineWiseCopyCut", !0), Dl("pasteLinesPerSelection", !0), Dl("selectionsMayTouch", !1), Dl("readOnly", !1, function (e, t) {
    ...
    }, !0), Dl("dragDrop", !0, al), Dl("allowDropFileTypes", null), Dl("cursorBlinkRate", 530), Dl("cursorScrollMargin", 0), Dl("cursorHeight", 1, lr, !0), Dl("singleCursorHeightPerLine", !0, lr, !0), Dl("workTime", 100), Dl("workDelay", 100), Dl("flattenSpans", !0, fi, !0), Dl("addModeClass", !1, fi, !0), Dl("pollInterval", 100), Dl("undoDepth", 200, function (e, t) {
        return e.doc.history.undoDepth = t
    }), Dl("historyEventDelay", 1250), Dl("viewportMargin", 10, function (e) {
        return e.refresh()
    }, !0), Dl("maxHighlightLength", 1e4, fi, !0), Dl("moveInputWithCursor", !0, function (e, t) {
        t || e.display.input.resetPosition()
    }), Dl("tabindex", null, function (e, t) {
        return e.display.input.getField().tabIndex = t || ""
    }), Dl("autofocus", null), Dl("direction", "ltr", function (e, t) {
        return e.doc.setDirection(t)
    }, !0), Dl("phrases", null), Ol = (Nl = cl).optionHandlers, Al = Nl.helpers = {}, Nl.prototype = {
        constructor: Nl,
        focus: function () {
        ...
        indentLine: Ir(function (e, t, n) {
            "string" != typeof t && "number" != typeof t && (t = null == t ? this.options.smartIndent ? "smart" : "prev" : t ? "add" : "subtract"), Je(this.doc, e) && dl(this, e, t, n)
        }),
        indentSelection: Ir(function (e) {
            for (var t = this.doc.sel.ranges, n = -1, r = 0; r < t.length; r++) {
                var i = t[r];
                if (i.empty()) i.head.line > n && (dl(this, i.head.line, e, !0), n = i.head.line, r == this.doc.sel.primIndex && wr(this)); else {
                    for (var o = i.from(), l = i.to(), i = Math.max(n, o.line), n = Math.min(this.lastLine(), l.line - (l.ch ? 0 : 1)) + 1, s = i; s < n; ++s) dl(this, s, e);
        ...
        lineAtHeight: function (e, t) {
            return e = En(this, {top: e, left: 0}, t || "page").top, Qe(this.doc, e + this.display.viewOffset)
        },
        heightAtLine: function (e, t, n) {
            var r, i = !1,
                e = "number" == typeof e ? (r = this.doc.first + this.doc.size - 1, e < this.doc.first ? e = this.doc.first : r < e && (e = r, i = !0), Ye(this.doc, e)) : e;
            return Pn(this, e, {top: 0, left: 0}, t || "page", n || i).top + (i ? this.doc.height - Gt(e) : 0)
        },
        ...
        findPosV: function (e, t, n, r) {
            ...
            for (var l = at(this.doc, e), s = 0; s < t; ++s) {
                var a = Rn(this, l, "div");
                if (null == o ? o = a.left : a.left = o, (l = Cl(this, a, i, n)).hitSide) break
            }
            return l
        },
        moveV: Ir(function (r, i) {
            ...
            }, V), s.length) for (var e = 0; e < l.sel.ranges.length; e++) l.sel.ranges[e].goalColumn = s[e]
        }),
        findWordAt: function (e) {
            var t = Ye(this.doc, e.line).text, n = e.ch, r = e.ch;
            if (t) {
        ...
        scrollIntoView: Ir(function (e, t) {
            ...
            null == e ? (e = {
                ...
                from: e,
                to: null
            }), e.to || (e.to = e.from), e.margin = t || 0, null != e.from.line ? (n = e, Cr(t = this), t.curOp.scrollToPos = n) : Sr(this, e.from, e.to, e.margin)
        }),
        setSize: Ir(function (e, t) {
            ...
            var r = this;
            null != e && (this.display.wrapper.style.width = n(e)), null != t && (this.display.wrapper.style.height = n(t)), this.options.lineWrapping && An(this);
        ...
        refresh: Ir(function () {
            ...
            tr(this), this.curOp.forceUpdate = !0, Dn(this), xr(this, this.doc.scrollLeft, this.doc.scrollTop), jr(this.display), (null == e || .5 < Math.abs(e - Yn(this.display)) || this.options.lineWrapping) && Qn(this), be(this, "refresh", this)
        }),
    ...
    }, Se(Nl), Nl.registerHelper = function (e, t, n) {
    ...
    for (Wl in ho.prototype) ho.prototype.hasOwnProperty(Wl) && R(Fl, Wl) < 0 && (cl.prototype[Wl] = function (e) {
        return function () {
            return e.apply(this.doc, arguments)
        }
    }(ho.prototype[Wl]));
    return Se(ho), cl.inputStyles = {textarea: r, contenteditable: e}, cl.defineMode = function (e) {
        cl.defaults.mode || "null" == e || (cl.defaults.mode = e), function (e, t) {
            2 < arguments.length && (t.dependencies = Array.prototype.slice.call(arguments, 2)), Ie[e] = t
        ...
        n.finishInit = function (e) {
            e.save = r, e.getTextArea = function () {
                ...
                e.toTextArea = isNaN, r(), t.parentNode.removeChild(e.getWrapperElement()), t.style.display = "", t.form && (ye(t.form, "submit", r), n.leaveSubmitMethodAlone || "function" != typeof t.form.submit || (t.form.submit = o))
            }
